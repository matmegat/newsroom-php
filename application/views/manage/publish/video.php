			...
			<div class="row-fluid">
				...
				<div class="span6">
					<div class="pull-right">
						<a href="manage/publish/video/edit" class="bt-publish bt-orange">Submit Video</a>
					</div>
				</div>
			</div>
		</header>
...
<div class="row-fluid">
	<div class="span12">
		<ul class="nav nav-tabs nav-activate" id="tabs">
			<li><a data-on="^manage/publish/video/all" href="manage/publish/video/all">All</a></li>
			<li><a data-on="^manage/publish/video/published" href="manage/publish/video/published">Published</a></li>
			<li><a data-on="^manage/publish/video/scheduled" href="manage/publish/video/scheduled">Scheduled</a></li>
			<li><a data-on="^manage/publish/video/draft" href="manage/publish/video/draft">Draft</a></li>
		</ul>
	</div>
</div>
