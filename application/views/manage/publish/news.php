<div class="row-fluid">
	<div class="span12">
		<header class="page-header">
			<div class="row-fluid">
				<div class="span6">
					<h1>News Content Manager</h1>
				</div>
				<div class="span6">
					<div class="pull-right">
						<a href="manage/publish/news/edit" class="bt-publish bt-orange">Submit News Content</a>
					</div>
				</div>
			</div>
		</header>
...
<div class="row-fluid">
	<div class="span12">
		<ul class="nav nav-tabs nav-activate" id="tabs">
			<li><a data-on="^manage/publish/news/all" href="manage/publish/news/all">All</a></li>
			<li><a data-on="^manage/publish/news/published" href="manage/publish/news/published">Published</a></li>
			<li><a data-on="^manage/publish/news/scheduled" href="manage/publish/news/scheduled">Scheduled</a></li>
			<li><a data-on="^manage/publish/news/draft" href="manage/publish/news/draft">Draft</a></li>
		</ul>
	</div>
</div>
		...
		<div class="content listing">
			...
			<table class="grid">
				<thead>
					...
					<tr>
						<th class="left">News Content Title</th>
						<th>Publish Date</th>
						<th>Status</th>
					</tr>
				...
				<tbody>
					...
					<tr>
						<td class="left">
							<h3>
								<a href="manage/publish/news/edit/<?= $result->id ?>">
									<?= $vd->esc($vd->cut($result->title, 45)) ?>
								</a>
							</h3>
							<ul>
								<li><a href="view/<?= $result->slug ?>" target="_blank">View</a></li>	
								<li><a href="manage/publish/news/edit/<?= $result->id ?>">Edit</a></li>
								<li><a href="manage/publish/news/delete/<?= $result->id ?>">Delete</a></li>
