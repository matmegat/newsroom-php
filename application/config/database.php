...
$db['default']['username'] = 'freepr';
$db['default']['password'] = 'mikees2013';
$db['default']['database'] = 'freepr_v2';
...
$db['legacy'] = array();
$db['legacy']['hostname'] = '127.0.0.1';
$db['legacy']['username'] = 'freepr';
$db['legacy']['password'] = 'mikees2013';
$db['legacy']['database'] = 'freepr_inews';
$db['legacy']['dbdriver'] = 'mysql';
$db['legacy']['dbprefix'] = '';
$db['legacy']['pconnect'] = TRUE;
