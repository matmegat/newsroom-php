...
!function($) {
    ...
    var Colorpicker = function(element, options) {
        ...
        if (this.element.data('colorpicker-trans')) 
            this.picker.addClass('trans');
        
        this.picker.on('click', '.colorpicker-hue b', $.proxy(function() {
            var value = this.element.data('colorpicker-trans') ? 'transparent' : '';
            this.element.find('input').val(value).trigger('change');
            this.hide.call(this);
        }, this));
        
        this.picker.on('mousedown', '.colorpicker-hue b', $.proxy(function() {
            var value = this.element.data('colorpicker-trans') ? 'transparent' : '';
            this.element.find('input').val(value).trigger('change');
            return false;
        }, this));
    ...
    Colorpicker.prototype = {
        ...
        mousemove: function(e) {
            ...
            if (this.slider.callLeft) {
                this.color[this.slider.callLeft].call(this.color, left / this.slider.maxLeft);
            }
            if (this.slider.callTop) {
                this.color[this.slider.callTop].call(this.color, top / this.slider.maxTop);
            }
            this.previewColor();
    ...
    var CPGlobal = {
        ...
        template: '<div class="colorpicker dropdown-menu">' +
                ...
                '<div class="colorpicker-hue"><i></i><b></b></div>' +
